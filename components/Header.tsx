      ...
      <div className="flex items-center gap-3 md:gap-6">
        <div className="flex items-center gap-3 md:pr-6 md:border-r border-border-muted">
          <div className="text-right hidden sm:block">
            <p className="text-xs font-bold leading-none text-white">Alexander Pierce</p>
            <p className="text-[10px] text-primary font-medium mt-1">Global Admin</p>
          </div>
          <div 
            className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-center bg-cover border border-border-muted" 
            style={{backgroundImage: `url('https://picsum.photos/seed/alexander/100/100')`}}
          ></div>
        </div>
        <button 
          onClick={() => navigate('/')} 
