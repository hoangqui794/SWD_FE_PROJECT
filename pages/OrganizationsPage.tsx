    ...
    return (
        <Layout title="Organizations" breadcrumb="Administration">
            <div className="flex justify-between items-end mb-8">
                <div>
                    <h3 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Organizations Management</h3>
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-slate-50 dark:bg-zinc-900/50 border-b border-slate-200 dark:border-border-muted text-slate-500 dark:text-slate-400">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-[11px] font-extrabold uppercase tracking-widest text-inherit">Created At</th>
                ...
                <form className="p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full bg-slate-50 dark:bg-zinc-900 border border-slate-200 dark:border-border-muted rounded-lg px-4 py-3 text-sm focus:ring-1 focus:ring-primary outline-none text-slate-900 dark:text-white h-24 transition-colors"
            ...
            <Modal isOpen={!!deleteTargetId} onClose={() => setDeleteTargetId(null)} title="Confirm Deletion">
                <div className="p-6 space-y-4">
                    <div className="flex flex-col items-center justify-center text-center space-y-2 py-4">
                        ...
                        <h4 className="text-lg font-bold text-slate-900 dark:text-white">Delete Organization?</h4>
